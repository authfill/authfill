...
import { createImapConnection, checkIdleSupport } from "@proxy/services/imap";
...
export const handleImapWebSocket: Handler<{ Bindings: Env }, "/imap"> = upgradeWebSocket((c) => {
      ...
      try {
        ...
        switch (data.event) {
          ...
          case "fetch-emails":
            ...
            const emailCount = await handleEmailFetch(ws, imap, data.data.count || 3);
